#!/bin/bash
# Rewrite select_page.php correctly without duplication

cat > /tmp/select_page_correct.php << 'EOF'
<?php
...
sudo cp /tmp/select_page_correct.php www/www/includes/select_page.php
sudo chmod 644 www/www/includes/select_page.php
echo "✅ Fixed select_page.php with correct if-else structure"
